 ...
 */
struct User {
    static var currentUser : User = User(userName: "Defalt", email: "Default", age: 0)
    var userName: String
    var email: String
    var age: Int
...
let me = User(userName: "Harry", email: "Dfaf@.daf.r", age: 16)
let friend = User(userName: "ha", email: "af@adf.ra", age: 18)
